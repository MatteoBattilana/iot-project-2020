...
* EXTERNAL WEATHER API:
  ...
  - forecast pollution at latitude LAT and longitude LON: [http://localhost:8070/forecastPollution?lat=LAT&lon=LON](http://localhost:8070/forecastPollution?lat=45.06226619601743&lon=7.661825314722597)
  - tomorrow pollution at latitude LAT and longitude LON: [http://localhost:8070/tomorrowPollution?lat=LAT&lon=LON](http://localhost:8070/tomorrowPollution?lat=45.06226619601743&lon=7.661825314722597)]