...
void MQ135::begin(){
    r0CO=getRZeroCO();
    r0CO2=getRZeroCO2();
    r0Ethanol=getRZeroEthanol();
    r0NH4=getRZeroNH4();
    r0Toluene=getRZeroToluene();
    r0Acetone=getRZeroAcetone();
    Serial.print("Ro CO MQ135: ");
    Serial.print(r0CO);
    Serial.println(" ohm");
  Serial.print("Ro CO2 MQ135: ");
    Serial.print(r0CO2);
    Serial.println(" ohm");
  Serial.print("Ro Ethanol MQ135: ");
    Serial.print(r0Ethanol);
    Serial.println(" ohm");
  Serial.print("Ro NH4 MQ135: ");
    Serial.print(r0NH4);
    Serial.println(" ohm");
  Serial.print("Ro Toluene MQ135: ");
    Serial.print(r0Toluene);
    Serial.println(" ohm");
    Serial.print("Ro Acetone MQ135: ");
    Serial.print(r0Acetone);
    Serial.println(" ohm");
}
/**************************************************************************/
/*!
...
float MQ135::getResistance() {
  ...
  for (i=0;i<READ_SAMPLE_TIMES;i++) {
    ...
    rs += ((1024./(float)val) * 5. - 1.)*RLOAD;
    delay(READ_SAMPLE_INTERVAL);
  }

  rs = rs/READ_SAMPLE_TIMES;
  return rs*(startingVoltage/realVoltage); 
